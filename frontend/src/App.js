...
import TwoUpdatePlanningWrapper from './components/Maps/2UpdateEventPlanningMap';
  ...
  return loaded && (
    <>
      ...
      <Switch>
        ...
        <ProtectedRoute exact path="/events/:eventId/update-event" component={TwoUpdatePlanningWrapper} />
