...
export const TwoUpdatePlanning = () => {
  ...
  const startPlanning = () => {
    ...
    console.log('pinsref', pinsRef.current)
  ...
  const addPin = (location, map) => {
    console.log('npr', numPointsRef.current)
    _setNumPoints(numPointsRef.current + 1);
    const marker = new window.google.maps.Marker({
...
const TwoUpdatePlanningWrapper = () => {
  return (
...
export default TwoUpdatePlanningWrapper;