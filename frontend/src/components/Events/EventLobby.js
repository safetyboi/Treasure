...
const EventLobby = () => {
  ...
  return (
    <section className="event_lobby_page">
      ...
      <div className="event_lobby_wrapper flex-row">
        <div className="event_details">
          <div className="event_preview">
            <h1>{event.name}</h1>
            <p>By {!event.creator.username ? null : event.creator.username}</p>
            <p><i className="fa-solid fa-dollar-sign"></i>{event.price}</p>
          </div>
